import { getAnalystViews, getPortfolioSummary, getPositions } from "@/lib/api";
...
export default async function PositionsPage() {
  const [{ metrics, cash }, { totals }, analystViews] = await Promise.all([
    getPositions(),
    getPortfolioSummary(),
    getAnalystViews(),
  ]);
  ...
  return (
    <>
      ...
      <AnalystPanel metrics={metrics} views={analystViews} />
    </>
  );
}
